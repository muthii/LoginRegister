...
<head>
  ...
  <title>LoginRegisterApp | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?php echo e(asset ('dist/img/Strathmore-University-300x217.jpg')); ?>" alt="SU Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">LoginRegisterApp</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('categories-list')); ?>" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2022 <a href="#">LoginRegisterApp</a>.</strong>
    All rights reserved.
...
<?php /**PATH /home/muthii/LoginRegister/resources/views///layouts/admin.blade.php ENDPATH**/ ?>